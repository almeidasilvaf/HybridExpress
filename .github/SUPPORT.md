# Getting help with `HybridExpress`

Thank you for using `HybridExpress`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/HybridExpress`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/HybridExpress),
...
[search issues and pull requests](https://github.com/almeidasilvaf/HybridExpress/issues)
